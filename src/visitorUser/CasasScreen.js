    ...
    <div>
      ...
      <div style={{ backgroundColor: '#535353', paddingTop: '10vh', paddingBottom: '10vh' }}>
        <div className='container'>
          <div style={{ color: '#ffffff', textAlign: 'justify', fontSize: '1.5rem', fontWeight: 'bold' }}>
          ...
          <div className='container'>
            <div className='row'>
              <div className='col-12 col-sm-6'>
                <div style={{ color: '#ffffff', textAlign: 'justify', fontSize: '1.5rem', paddingTop: '5vh' }}>
            ...
            <div style={{ color: '#ffffff', textAlign: 'center', fontSize: '1.5rem', paddingTop: '5vh' }}>
          ...
          <div className='container'>
            <div className='row'>
              <div className='col-12 col-sm-6'>
                ...
                <div style={{ color: '#ffffff', textAlign: 'justify', fontSize: '1.5rem'}}></div>
