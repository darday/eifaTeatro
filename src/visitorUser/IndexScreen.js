...
import PlanEstudio from './PEstudios.pdf'
import EifaInfo from './BROCHURE.pdf'
              ...
              <div className='col-12 col-sm-12 col-md-12 col-lg-6'>
                <div >
                  ...
                  <a href={EifaInfo} target="_blank"
                    ...
                    <button type="button" className="btn btn-outline-light" >BROCHURE EIFA 2024</button>
                  </a>
                  <br></br>
                  <br></br>
                </div>
                ...
                <a className='titulos-grandes-directora' href={PlanEstudio} target="_blank"
                  style={{ color: 'white', fontSize: '1rem', textDecoration: 'none', paddingLeft: '1vw' }}><b> PLAN DE ESTUDIOS EIFA 2024</b>
                </a>
              </div>
            </div>
          </div>
