        ...
        <div className='container'> 
          <div style={{ paddingBottom: '4vh' }}> 
            <div className='row'>
              ...
              <center> <img className="espacio-img-index" src= { `./assets/img/Sello-EIFA.png` } style={{ paddingTop: '5vw' }} width="65%" height= 'auto' ></img></center>
              </div>
              <div className='col-12 col-sm-12 col-md-12 col-lg-6'> 
              <center> <img className="espacio-img-index" src= { `./assets/img/QS2.png` } style={{ paddingTop: '5vw' }} width="100%" height= 'auto' ></img></center>
                <div style={{ textAlign: 'justify', color: '#e8eaed', fontSize: '1.5rem', paddingLeft: '1vw', paddingRight: '1vw', paddingTop: '2vw'}}>Somos una <b style={{color:'white', fontStyle: 'italic'}}>
                ...
                <a className='titulos-grandes-directora' href={PlanEstudio} target="_blank"
                  style={{color:'white', fontSize: '1.5rem', textDecoration: 'none', paddingLeft: '1vw'}}> DESCARGAR PLAN DE ESTUDIOS
                </a>
              </div>              
            </div>               
          </div>
        ...
        <div style={{ paddingBottom: '5vh' }}>
          <div className='row'>
            ...
            <center><img src= { `./assets/img/Matriculasicono9.png` } width="35%" height= 'auto' style={{ paddingTop: '7vh' }}></img></center>
              <div className='titulos-grandes' style={{ textAlign: 'center', paddingTop: '4vh', fontSize: '1.5rem',color:'#4d5480'}}><b className='titulos-grandes' style={{ fontWeight: '900 !important' }}><label><strong className='titulos-grandes'>TENEMOS CONVENIOS INTERNACIONALES</strong></label></b></div>
        ...
        <div className='container'> 
          <div style={{ paddingBottom: '4vh', paddingTop: '4vw' }}> 
            <h3 className='titulos-grandes-directora' style={{ textAlign: 'justify', color: '#e8eaed', fontSize: '2.5rem'}}>¿QUIÉNES SOMOS?</h3> 
              <div style={{ textAlign: 'justify', color: '#e8eaed', paddingTop: '2vh', fontSize: '1.4rem'}}>EIFA es una Escuela Integral de Formación de Artistas que trabaja para aportar al medio
          ...
          <div style={{ paddingBottom: '5vh' }}>
            <div className='row' style={{ paddingTop: '7vh'}}>
              <div className='col-12 col-sm-6'>
                ...
                <div style={{ textAlign: 'justify', padding: '3vh',color:'#4d5480', fontSize: '1.4rem'}}>EIFA es una Escuela Integral de 
              ...
              <div className='col-12 col-sm-6'>
                ...
                <div style={{ textAlign: 'justify', padding: '3vh',color:'#4d5480', fontSize: '1.4rem' }}>La Escuela de Formación de Artistas 
      ...
      <div style={{ backgroundColor: '#e77825' }}> 
        <div className='container'>
          <div className='row' style={{paddingBottom:'5vh', paddingTop: '5vh'}}>
            <div className='col-12 col-sm-12 col-md-12 col-lg-6'>
             <center><img src= { `./assets/img/Mary.png` } width= "100%" height= "auto" ></img></center>                
            </div>
            <div className='col-12 col-sm-12 col-md-12 col-lg-6' >
            <h1 className='titulos-grandes-directora' style={{color: '#e8eaed', fontSize: '2.5rem' }}>DIRECTORA</h1>
              <div className='titulos-grandes-directora' style={{ color: '#e8eaed', fontSize: '2rem' }}>MARÍA DEL CARMEN CALDERÓN</div>
              <div style={{ textAlign: 'justify', paddingTop: '4vh', color: '#e8eaed', fontSize: '1.2rem'}}>Doctora en Ciencias de la 
              ...
              <div style={{ textAlign: 'justify', color: '#e8eaed', fontSize: '1.2em' }}>Se ha capacitado a través de varios 
        ...
        <div className='row'>
          <div className='col-12 col-sm-6' style={{paddingBottom:'5vh'}}>
            <h1 className='titulos-grandes' style={{ color:'#4d5480' }}>CONTACTOS</h1>
              <div style={{ textAlign: 'justify', paddingTop: '5vh', paddingBottom: '3vh', color: '#666666', fontSize: '1.2rem' }}>
              ...
              <div style={{ color: '#666666', textAlign: 'Justify', fontSize: '1.2rem' }}>
